...
// list the sequences in source fasta-refseqs-concatenated-srlv
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'fasta-refseqs-concatenated-srlv'"]);
...
_.each(seqIds, function(seqId) {
    ...
    // associate the corresponding sequence with this object.
    glue.inMode("sequence/fasta-refseqs-concatenated-srlv/"+seqId, function() {
        glue.command(["set", "link-target", "isolate_data", "custom-table-row/isolate_data/"+seqId]);
    });
